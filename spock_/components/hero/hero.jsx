      ...
      <section className="hero relative py-20 md:pt-32">
        ...
        <div className="container">
          <div className="mx-auto max-w-2xl pt-24 text-center">
            <h1 className="font-display text-5xl text-jacarta-700 dark:text-green lg:text-5xl xl:text-6xl">i3-Earth</h1>
            <h2 className="font-display text-5xl text-jacarta-500 dark:text-white lg:text-3xl xl:text-6xl ">
              Buy, sell and create your Own
            </h2>
            <h2 className="font-bold animate-gradient text-2xl lg:text-3xl xl:text-4xl mb-10">
              {" "}
              NFT / Avatar / Painting / File / Music / Fashion
            </h2>
            {/* <!-- Search --> */}
